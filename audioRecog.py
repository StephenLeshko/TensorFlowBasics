...
#extracing audio clips into filenames
...
#function that transforms WAV file into audio & label tensors 
...
#will use CNN using the audio files as spectrograms
